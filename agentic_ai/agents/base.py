...
class BaseAgent:
    ...
    def __init__(self, agent_id: Optional[str] = None, name: Optional[str] = None,
                 inference_engine: Optional[Any] = None, state_store: Optional[Any] = None,
                 message_bus: Optional[Any] = None,
                 permission: Optional[Permission] = None, knowledge: Optional[Any] = None,
        ...
        self.rate_limiter = rate_limiter  # Optional RateLimiter; None means no limiting
    ...
    def log(self, action: str, details: Optional[Dict[str, Any]] = None):
    ...
    async def call_tool(self, tool_name: str, **kwargs) -> Dict[str, Any]:
        ...
        # Rate limiting
        if self.rate_limiter and not self.rate_limiter.acquire(self.agent_id, f"tool:{tool_name}"):
            return {"error": f"Rate limit exceeded for tool '{tool_name}'", "rate_limited": True}
    ...
    def send_message(self, recipient: str = "", content: str = "", msg_type: str = "info", **kwargs):
        ...
        # Rate limiting
        if self.rate_limiter and not self.rate_limiter.acquire(self.agent_id, "send_message"):
            logger.warning(f"Rate limit exceeded for send_message: {self.agent_id}")
    ...
    async def reason(self, prompt: str, context: Optional[Dict[str, Any]] = None,
    ...
    async def reflect(self, response: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
...
Improved: <better version of the response, or "N/A" if good enough>"""
    ...
    async def perform_task(self, task_type: str, payload: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
