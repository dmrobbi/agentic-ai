...
# Sends to RECIPIENT via reports@example.com.
#
...
#   non-empty 24h window. See /home/user/bin/wazuh-indexer-selftest.sh.
...
LOGFILE="${LOGFILE:-/home/user/logs/wazuh-digest.log}"
...
LOG_TAG="${LOG_TAG:-wazuh-daily-digest}" /home/user/bin/wazuh-indexer-selftest.sh || {
...
---
Generated by /home/user/bin/wazuh-daily-digest.sh (cron 0 18 * * *).
Snapshot: $SNAP
EOF
)
